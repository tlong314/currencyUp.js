...
;var UpCurrency = (function(global, undefined){
	 ...
	 * @param {Object} opts - constructor options (`element` is currently the only available option).
	 * @param {Object} options.element - The HTML element receiving this functionality.
	 */
	var UpCurrency = function(opts){
		...
		// Can't do much if we've got nothing to do it with...
		if(!options.element) {
			return;
		}
